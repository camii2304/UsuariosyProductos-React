...
const ShowProducts = () => {
    const url = 'http://localhost:7000/api/product';
        ...
        <>
            ...
            <AppBar position="static">
                <Toolbar>
                    ...
                    <input value={searchP} onChange={searcherP} type='text' placeholder='Busca tu producto'/>
                    <Button sx={{margin: 2}} variant="contained" color="secondary" onClick={() => openModal(1)}>
                        Añadir Producto
                    </Button>
                    <Button variant="contained" color="warning" onClick={handleClick}>Ver Usuarios</Button>
                </Toolbar>
            </AppBar>
